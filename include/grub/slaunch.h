 ...
 * that the table should be stored near OS2MLE data (right after it) and enjoy
 * the same level of protection. In this case:
 ...
 *     initialization by the code which used this constant.
 */
